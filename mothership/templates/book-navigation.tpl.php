    ...
    <?php if ($has_links): ?>
      ...
      <?php if ($prev_url): ?>
        <li class="page-previous">
          <a href="<?php print $prev_url; ?>" rel="prev" title="<?php print t('Go to previous page'); ?>"><?php print t('‹ ') . $prev_title; ?></a>
        </li>
      <?php endif; ?>
      <?php if ($parent_url): ?>
        <li class="page-up" >
      ...
      <?php if ($next_url): ?>
        <li class="page-next">
          <a href="<?php print $next_url; ?>" rel="next" title="<?php print t('Go to next page'); ?>"><?php print $next_title . t(' ›'); ?></a>
        </li>
      <?php endif; ?>
    </ul>
    <?php endif; ?>
